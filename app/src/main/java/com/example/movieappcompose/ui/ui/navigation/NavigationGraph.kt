...
import com.example.movieappcompose.ui.ui.fav.FavScreen
...
import com.example.movieappcompose.ui.ui.profile.ProfileScreen
...
fun NavigationGraph(
    ...
    NavHost(
        ...
        composable("HomeScreen") {
            HomeScreen(navController = navController, modifier = modifier , viewModel = HomeViewModel(MovieRepository(networkService)))
        }

        composable("DetailScreen"){
            DetailScreen(navController = navController, modifier = modifier , viewModel = DetailScreenViewModel(MovieRepository(networkService)))
        }

        composable("FavScreen"){
            FavScreen(navController = navController, modifier = modifier , viewModel = DetailScreenViewModel(MovieRepository(networkService)))
        }
        ...
        composable("PopularMoviesScreen"){
            PopularMoviesScreen(navController = navController, modifier = modifier , viewModel = PopularMoviesViewModel(MovieRepository(networkService)))
        }
        composable("TopRatedMoviesScreen"){
            TopRatedMoviesScreen(navController = navController, modifier = modifier , viewModel = TopRatedMoviesViewModel(MovieRepository(networkService)))
        }
        composable(
            ...
            DetailMovieScreen(movieId = movieId , navController = navController , modifier = modifier , viewModel = DetailMovieViewModel(MovieRepository(networkService)))
        }
    }
}